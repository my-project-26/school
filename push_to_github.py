...
print("🚀 Erstelle Git Repository & lade Code zu GitHub hoch...")
run_cmd("git init")
run_cmd("git add .")
run_cmd("git commit -m 'Initial Commit: PWA Schul-App mit 6 Modulen'")
run_cmd("git branch -M main")
run_cmd("git remote remove origin")
run_cmd("git remote add origin https://github.com/my-project-26/school.git")
run_cmd("git push -u origin main")

print("\n✨ Upload beendet! Pruefe deine GitHub Seite.")
