...
# 0. .nojekyll & .gitignore ERSTELLEN (Löst das rote ❌ auf GitHub Actions)
...
# 1. INDEX.HTML (Alle Pfade strikt relativ mit ./)
...
# 4. SW.JS
sw_content = """const CACHE_NAME = 'schul-app-v13';
const ASSETS = [
  './',
  './index.html',
  './style.css',
...
run_cmd("git add .")
run_cmd("git commit -m 'Fix: Reparierter Push mit .nojekyll für GitHub Pages'")
run_cmd("git branch -M main")
run_cmd("git push -u origin main")

print("\n✨ Upload beendet! Warte 1-2 Minuten und rufe deine Seite auf.")
