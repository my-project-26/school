...
# 1. INDEX.HTML mit aufklappbarem Mobil-Menü
...
<body>
    ...
    <header>
        <!-- Desktop Tabs (auf großen Bildschirmen sichtbar) -->
        ...
        <!-- Mobile Menu Trigger (auf Smartphones sichtbar) -->
...
# 2. STYLE.CSS mit Breakpoints für Mobile Menu
css_content = """:root {
    --bg-color: #F0F4F8;
    --card-bg: #FFFFFF;
...
# 3. APP.JS mit Mobile Menu Event Handling
...
# 4. SW.JS
sw_content = """const CACHE_NAME = 'schul-app-v17';
const ASSETS = [
  './',
  './index.html',
  './style.css',
...
print("🚀 Lade Update mit aufklappbarem Mobil-Menü zu GitHub hoch...")
run_cmd("git add .")
run_cmd("git commit -m 'Feat: Responsive Mobile Drawer Navigation for iPhone'")
