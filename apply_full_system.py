...
<body>
    ...
    <!-- Start-Overlay für Audio-Unlock (Safari/iOS Fix) -->
    ...
    <main class="container">
        ...
        <section id="module-k1-silben" class="module-card hidden">
            <div class="card game-card">
                ...
                <button id="btn-play-silben-audio" class="btn-audio">
                    🔊 Wort anhören
                </button>
                <div class="image-container">
                    <span id="silben-emoji" class="emoji-display">❓</span>
                </div>
...
function switchTab(activeTab, activeModule) {
    [tabK1Anlaut, tabK1Silben, tabK3Math, tabK3Lang].forEach(t => t.classList.remove('active'));
    [moduleK1Anlaut, moduleK1Silben, moduleK3Math, moduleK3Lang].forEach(m => m.classList.add('hidden'));
...
// KLASSE 1: SILBEN SCHWINGEN LOGIK
const silbenData = [
...
const btnPlaySilbenAudio = document.getElementById('btn-play-silben-audio');
...
btnPlaySilbenAudio.addEventListener('click', () => playAudioFile(silbenData[indexSilben].audio));
...
# 4. SW.JS
sw_content = """const CACHE_NAME = 'schul-app-v2';
const ASSETS = [
  './',
  './index.html',
  './style.css',
...
print("✨ Gesamtsystem inkl. Silben-Modul erfolgreich geschrieben!")
