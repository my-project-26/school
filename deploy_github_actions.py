...
# 1. ERSTELLE DEN WORKFLOW-ORDNER UND DIE DEPLOYMENT-DATEI
...
# 5. SW.JS
sw_content = """const CACHE_NAME = 'schul-app-v14';
const ASSETS = [
  './',
  './index.html',
  './style.css',
...
print("🚀 Führe Push mit GitHub Actions Workflow aus...")
run_cmd("git add .")
run_cmd("git commit -m 'Feat: Add Actions workflow for static site deployment'")
