...
# 0. DEPLOYMENT-HELFER: .nojekyll & .gitignore erstellen
open(".nojekyll", "w").write("") # Verhindert Jekyll-Build-Fehler auf GitHub Pages
...
# 4. SW.JS (Mit .nojekyll Support & Dynamic Root Detection)
sw_content = """const CACHE_NAME = 'schul-app-v12';
const ASSETS = [
  './',
  './index.html',
  './style.css',
...
print("🚀 Führe sauberen Git-Push mit .nojekyll durch...")
run_cmd("git add .")
run_cmd("git commit -m 'Fix: Add .nojekyll and clean static assets for GitHub Pages'")
run_cmd("git branch -M main")
run_cmd("git push -u origin main")

print("\n✨ Skript beendet! Warte 2 Minuten und rufe https://my-project-26.github.io/school/ auf.")
