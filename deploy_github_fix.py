...
# 1. INDEX.HTML (Mit relativen Ressourcen-Pfaden)
...
<body>
    ...
    <!-- Audio-Unlock Overlay (Safari/iOS Autoplay Policy Fix) -->
...
# 3. APP.JS (Relativer Service Worker & Dynamische Pfade)
...
# 4. SW.JS (Strict Relative Caching for GitHub Subpath)
sw_content = """const CACHE_NAME = 'schul-app-v10';
const ASSETS = [
  './',
  './index.html',
  './style.css',
...
print("🚀 Führe Git-Commit & Push zu GitHub aus...")
run_cmd("git add .")
run_cmd("git commit -m 'Fix: PWA Unterpfad Verweise für GitHub Pages'")
run_cmd("git branch -M main")
run_cmd("git push -u origin main")

print("\n✨ Skript beendet! Lade jetzt die HTTPS-URL im Browser neu.")
