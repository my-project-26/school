...
# 2. EXTENDED CONTENT.JSON (Syntax-Fix bei Traube)
expanded_content = {
    "obst_gemuese": [
...
# 4. STYLE.CSS (iOS Touch-Highlight & Text-Select Lock)
css_content = """:root {
    --bg-color: #F0F4F8;
    --card-bg: #FFFFFF;
...
# 6. SW.JS
sw_content = """const CACHE_NAME = 'schul-app-v22';
const ASSETS = [
  './',
  './index.html',
  './style.css',
...
print("🚀 Lade gefixtes v22 Update zu GitHub hoch...")
run_cmd("git add .")
run_cmd("git commit -m 'Fix: Syntax error fix for Traube and update to v22'")
run_cmd("git branch -M main")
run_cmd("git push -u origin main")

print("\n✨ Deployment v22 erfolgreich gestartet!")
