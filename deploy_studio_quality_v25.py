    ...
    <main class="container">
        ...
        <section id="module-k3-spell" class="module-card hidden">
            <div class="card game-card">
                ...
                <button id="btn-play-spell-audio" class="btn-audio" style="margin-bottom:0.8rem;">🔊 Wort anhören</button>
                <div class="sentence-box">
...
# 5. SW.JS
sw_content = """const CACHE_NAME = 'schul-app-v25';
const ASSETS = [
  './',
  './index.html',
  './style.css',
...
print("🚀 Lade glasklares Audio-Update v25 zu GitHub hoch...")
run_cmd("git add .")
run_cmd("git commit -m 'Feat: Add studio quality Anna audio files and update to v25'")
run_cmd("git branch -M main")
run_cmd("git push -u origin main")

print("\n✨ Deployment v25 gestartet!")
