...
expanded_content = {
    "obst_gemuese": [
        ...
        {"word": "Zitrone", "letter": "Z", "emoji": "🍋", "syllables": 3},
...
# 3. INDEX.HTML (Inklusive Audio-Button für Rechtschreibung)
    ...
    <main class="container">
        ...
        <section id="module-k3-spell" class="module-card hidden">
            <div class="card game-card">
                ...
                <button id="btn-play-spell-audio" class="btn-audio" style="margin-bottom:0.8rem;">🔊 Wort & Tipp anhören</button>
                <div class="sentence-box">
...
# 5. APP.JS (GLOBALE HYBRID SPEECH ENGINE FÜR ALLE WÖRTER & SPELLING)
...
# 6. SW.JS (Cache v23)
sw_content = """const CACHE_NAME = 'schul-app-v23';
const ASSETS = [
  './',
  './index.html',
  './style.css',
...
print("🚀 Lade gefixtes v23 Update mit globaler Audio-Engine für ALLE Wörter hoch...")
run_cmd("git add .")
run_cmd("git commit -m 'Feat: Global Speech Engine for 200+ vocabulary words & Rechtschreibung'")
run_cmd("git branch -M main")
run_cmd("git push -u origin main")

print("\n✨ Deployment v23 gestartet!")
