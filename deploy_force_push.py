...
<body>
    ...
    <!-- Audio-Unlock Overlay (Safari/iOS Fix) -->
...
# 4. SW.JS
sw_content = """const CACHE_NAME = 'schul-app-v11';
const ASSETS = [
  './',
  './index.html',
  './style.css',
...
run_cmd("git add .")
run_cmd("git commit -m 'Fix: Reparierter Push für GitHub Pages'")
run_cmd("git branch -M main")
run_cmd("git push -f origin main")

print("\n✨ Force Push abgeschlossen! Pruefe die GitHub Actions.")
