...
# 3. APP.JS (BEREINIGT VON PYTHON-SYNTAX-FEHLERN)
...
// KLASSE 3: HALBSCHRIFTLICHES RECHNEN LOGIK (REIN JS)
...
# 4. SW.JS
sw_content = """const CACHE_NAME = 'schul-app-v5';
const ASSETS = [
  './',
  './index.html',
  './style.css',
...
print("✨ Reparatur-Update erfolgreich geschrieben!")
